...
{                               // Initialisation of the DeveloperGroup-structure with logo
...
{  // Initialisation of a function to add a developer to the group
    if (group->numDevelopers < 10)
    {  // If the number of developers in the group is less than 10
...
{                                                // Initialisation of a function to print the group logo
    printf("Group Logo: \n %s\n", group->logo);  // Print the group logo
}

void printCombination(const DeveloperGroup *group)
{                           // Initialisation of a function to print the group logo and list developers
...
{                             // Initialisation of a function to list the developers in the group
    printf("Developers:\n");  // Print "Developers:"
    for (int i = 0; i < group->numDevelopers; i++)
    {                                           // For every developer in the group
